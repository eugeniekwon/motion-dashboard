...
speedometerTLSeven.fromTo("#speed-thirtyeight", {opacity: 1}, {opacity:0, duration:0.5}, "to fifteen")
                .fromTo("#speed-twentyfive", {opacity: 0}, {opacity:1, duration:0.5}, "to fifteen")

                .fromTo("#speed-twentyfive", {opacity: 1}, {opacity:0, duration:0.5, delay:0.5}, "to ten")
                .fromTo("#speed-ten", {opacity: 0}, {opacity:1, duration:0.5, delay:0.5}, "to ten")

                .fromTo("#speed-ten", {opacity: 1}, {opacity:0, duration:0.5, delay:0.5}, "to zero")
                .fromTo("#speed-zero", {opacity: 0}, {opacity:1, duration:0.5, delay:0.5}, "to zero")
...
speedometerTLEight.to("#navigation", {scale:0.85, duration:0.5})
